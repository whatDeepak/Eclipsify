...
class PostDetailsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.textViewLikes).text = "${post.likedBy.size}"
        findViewById<TextView>(R.id.textViewComments).text = "${post.comments.size}"


        // Set up RecyclerView for comments
        commentsAdapter = CommentsAdapter(this,post.comments)
        ...
        val buttonComment: ImageView = findViewById(R.id.buttonComment)
        ...
        if (currentUserCommented) {
            buttonComment.setImageResource(R.drawable.commentedbutton)
        } else {
            buttonComment.setImageResource(R.drawable.commentbutton)
        }
